...
public class CheckoutController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        name4.setText(HomeController.mlamp.getProductName());
        price4.setText(Double.toString(HomeController.wlamp.getProductPrice()));
        Image magiclamp = new Image(HomeController.mlamp.getProductImage());
    ...
    public void computeTotal(ActionEvent event) {
        ...
        if (HomeController.mlamp.getProductStatus()) {

            double qty = Double.parseDouble(choicebox4.getValue());
            HomeController.mlamp.setProductQuantity(qty);
            item4Amount = HomeController.mlamp.getProductPrice() * qty;
    ...
    public void getInitialAmount() {
        ...
        if (HomeController.mlamp.getProductStatus()) {
            totalAmount += HomeController.mlamp.getProductPrice();
        }
